...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-05-2022 a las 22:37:27
...
(2, 'Operador de Sistemas de Producción', 'Producción y Operación de las maquinarias que fabrican Tarjetas magnética para el sistema prepago de transporte MENDOBUS.', 'Expreso Jocolí El Cacique y otras U.T.E', 1),
(4, 'Jefe de Servicio Técnico-Programador', 'Coordinación, Servicio Técnico e instalación de Redes y servidores WAN-LAN', 'Treadin Computación', 1),
(5, 'Técnico informático', 'Reparación de Notebooks, instalación y configuración de sistemas operativos, backup, mantenimiento preventivo.', 'Q.H. Técnica', 1),
(6, 'Analista de Sistemas', 'Mantenimiento de las redes, Hardware y Software de los equipos informáticos.', 'Hospital Ministro Dr. Ramón Carrillo - Mendoza - Argentina', 1);
...
(1, 'Analista de Sistemas - Programador', 'Abelardo H. Piovano', '../../../assets/doc/CV.pdf');
